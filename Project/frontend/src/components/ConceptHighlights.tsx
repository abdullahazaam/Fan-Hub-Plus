  ...
  return (
    <section className="concept-highlights-section" aria-label="Portal highlights">
      <div className="highlights-grid">
        ...
        <article className="concept-card" onClick={onExploreWorld} role="button" tabIndex={0}>
          ...
          <div className="concept-card-body">
            ...
            <div className="concept-card-arrow" aria-hidden="true">→</div>
          </div>
        </article>

        {/* Card 2: Characters Spotlight */}
        <article className="concept-card" onClick={onExploreCharacters} role="button" tabIndex={0}>
          <div className="concept-card-media">
            <img
        ...
        <article className="concept-card" onClick={onExploreMedia} role="button" tabIndex={0}>
          <div className="concept-card-media">
            <img
              src="https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&q=80"
              alt="What's New This Month"
              className="concept-card-img"
              loading="lazy"
            />
            <div className="concept-card-overlay" />
